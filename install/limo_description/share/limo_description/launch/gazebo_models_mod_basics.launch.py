...
def generate_launch_description():
    ...
    rviz_config_file_path = 'rviz/rviz_config.rviz'
    ...
    use_sim_time = LaunchConfiguration('use_sim_time', default='false') #true
    ...
    start_gazebo_server_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={'world': world, 'verbose': 'false'}.items()) # Added 'verbose': 'true'

    # Start Gazebo client with verbose output   
    start_gazebo_client_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(pkg_gazebo_ros, 'launch', 'gzclient.launch.py')),
        condition=IfCondition(PythonExpression([use_simulator, ' and not ', headless])),
        launch_arguments={'verbose': 'false'}.items()) # Added 'verbose': 'true'
